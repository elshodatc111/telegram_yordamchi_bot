        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <h4 class="card-title mb-0 pb-0">Yangi targ'ibot materiallari</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('post_create_story') }}" method="post">
                        @csrf 
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="chat_id" class="my-2">chat_id</label>
                                <input type="number" name="chat_id" required class="form-control">
                            </div>
                            <div class="col-lg-6">
                                <label for="message_id" class="my-2">message_id</label>
                                <input type="number" name="message_id" required class="form-control">
                            </div>
                            <div class="col-lg-12">
